...
public class Transaction {
	...
	public ArrayList<TransactionOutput> outputs = new ArrayList<TransactionOutput>(); //Die Transaktionen die wir schicken
	...
	//Diese Methode nimmt das privatekey und die Nachricht von der Transaktion und Verslüsselt sie mit ECDSA
	public void generateSignature(PrivateKey privateKey) {
		String data = StringUtil.getStringFromKey(sender) + StringUtil.getStringFromKey(reciepient) + Float.toString(value)	;
		signature = StringUtil.applyECDSASig(privateKey,data);		
	}
	
	//diese Methode nimmt die Nachricht und überprüft die validität mit Hilfe von der Public key
