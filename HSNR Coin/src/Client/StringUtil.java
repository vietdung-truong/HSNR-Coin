...
public class StringUtil {
	...
	public static String applySha256(String input) {
		try {
			...
			// es wurde ein String 'input' eingegeben, dieser input wurde in Bytes
			// verwandelt und Durch Sha256 in 'hash' verschlüsselt
	...
	// diese Methode kreiert merkleroot. Solange es mehr als 1 Transaktion gibt,
	// wird ein weiteres tree level erstellt und die hashes von den TRansaktionen
	// durch SHA verschlüsselt und fusioniert
